...
CSampleFriend::CSampleFriend() : m_ImgSize(0, 0), m_ColSize(0, 0),
								 m_nNowFrame(0),
...
CSampleFriend::~CSampleFriend()
{
}

void CSampleFriend::Init()
{
	g_LoadManager->OpenDat("Resource/Data/Makzelo.dat") ;
...
void CSampleFriend::Update()
{
	Animation() ;
}

void CSampleFriend::Animation()
{
